...
async def chat(request: ChatRequest):
    try:
        answer = ask_academic_rag(request.question)
        return {"answer": answer, "session_id": request.session_id or "default"}
    except Exception as e:
        return {"answer": f"Error: {str(e)}", "session_id": request.session_id or "default"}
...
def syllabus_status():
    return {"syllabus_loaded": False, "message": "No syllabus loaded"}
